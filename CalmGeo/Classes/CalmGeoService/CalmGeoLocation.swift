...
public protocol MotionActivityType: MotionActivity {
  var confidence: CMMotionActivityConfidence { get }
}

public struct CalmMotionActivity: MotionActivityType {
  ...
  public var confidence: CMMotionActivityConfidence = .low
}
